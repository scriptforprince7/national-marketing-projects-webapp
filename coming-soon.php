...
<body>
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-section ptb-100 gradient-overlay full-screen" style="background: url('img/slider-img-1.jpg')no-repeat center center / cover">
            <div class="container">
                    ...
                    <div class="col-md-9 col-lg-7">
                        <div class="hero-content-left text-white text-center">
                            ...
                            <p class="lead">Our website is under construction. We'll be here soon with our new awesome
                                site, subscribe to be notified.</p>
