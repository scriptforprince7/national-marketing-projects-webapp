...
<!-- Mirrored from digimark.themetags.com/review.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 12:09:13 GMT -->
                ...
                <div class="row">
                        ...
                        <div class="single-review my-md-4 my-lg-4 my-sm-0">
                            <div class="testimonial-single shadow-sm gray-light-bg rounded p-4">
                                ...
                                <div class="client-ratting mt-2">
                                    ...
                                    <h6 class="font-weight-bold"><small class="font-weight-lighter">AppBeats</small>
                                    </h6>
                                </div>
                            </div>
                            <div class="client-info-wrap d-flex align-items-center mt-5">
                        ...
                        <div class="single-review my-md-4 my-lg-4 my-sm-0">
                            <div class="testimonial-single shadow-sm gray-light-bg rounded p-4">
                                ...
                                <div class="client-ratting mt-2">
                                    ...
                                    <h6 class="font-weight-bold"><small class="font-weight-lighter">AgencyCo</small>
                                    </h6>
                                </div>
                            </div>
                            <div class="client-info-wrap d-flex align-items-center mt-5">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="single-review my-md-4 my-lg-4 my-sm-0">
                            ...
                            <div class="client-info-wrap d-flex align-items-center mt-5">
                                <div class="client-img mr-3">
                                    <img src="img/client-5.jpg" alt="client" width="60" class="img-fluid rounded-circle shadow-sm" />
                                </div>
                                <div class="client-info">
                                    <h5 class="mb-0">Pirtle Karol</h5>
                                    <p class="mb-0">ThemeTags</p>
...
<!-- Mirrored from digimark.themetags.com/review.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 12:09:14 GMT -->
